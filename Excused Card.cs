...
{
	public partial class ExcusedCardForm : Form
	{
		private bool drag = false;
		private Point startPoint = new Point(0, 0);

		public ExcusedCardForm()
		{
			InitializeComponent();
		}

		public ExcusedCardForm(string date, string name, string adjective, string noun, string signed)
		{
			InitializeComponent();
